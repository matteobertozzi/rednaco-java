...
public class TestRowKey {
  @Test
  public void testPrefixEndKey() {
    Assertions.assertArrayEquals(new byte[] { 6 }, RowKey.prefixEndKey(new byte[] { 5 }));
    Assertions.assertArrayEquals(new byte[] { 2, 0 }, RowKey.prefixEndKey(new byte[] { 1, (byte)0xff }));
  }
  ...
  public record CompositeKey2 (int a, ByteArraySlice b, String c) implements Comparable<CompositeKey2> {
    ...
    public int compareTo(final CompositeKey2 o) {
      ...
      cmp = b.compareTo(o.b);
      if (cmp != 0) return cmp;
      return StringUtil.compare(c, o.c);
    }
  }
