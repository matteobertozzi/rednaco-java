...
public final class ThreadUtil {
  ...
  public static void conditionSignal(final Condition waitCond, final Lock lock) {
    lock.lock();
    try {
      waitCond.signal();
    } finally {
  ...
  public static void conditionSignalAll(final Condition waitCond, final Lock lock) {
    lock.lock();
    try {
      waitCond.signalAll();
    } finally {
