...
import io.github.matteobertozzi.rednaco.collections.arrays.ArrayUtil.IntArrayConsumer;
...
public class IntArray {
  ...
  public void forEach(final IntArrayConsumer consumer) {
    consumer.accept(items, 0, count);
  }
