...
public enum UriMethod {
  ...
  public static final UriMethod[] METHODS = UriMethod.values();
  public static final UriMethod[] METHODS_GET = { UriMethod.GET };
  public static final UriMethod[] METHODS_PUT = { UriMethod.PUT };
  public static final UriMethod[] METHODS_POST = { UriMethod.POST };
  public static final UriMethod[] METHODS_DELETE = { UriMethod.DELETE };
}
