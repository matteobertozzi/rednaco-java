...
public class Router {
  ...
  public static void main(final String[] args) {
    final Router router = new Router(new String[] {
      "/v1/lucchinirs/", "/"
    }, null, null);
    System.out.println(router.applyAlias("/v1/lucchinirs/runtime/metrics/dashboard"));
    System.out.println(router.applyAlias("/runtime/metrics/dashboard"));
  }
}
